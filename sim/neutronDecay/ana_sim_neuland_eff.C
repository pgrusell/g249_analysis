...
void ana_sim_neuland_eff(const Float_t nev = -1)
{
    ...
    // TString filename = "/nucl_lustre/pablogrusell/g249/g249_analysis/results/sim/sim_neutron_decay_fullErel.root";
    ...
    TH1F *h1_erel = new TH1F("h1_erel", "h1_erel", 300, 0, nErelLim);
    TH1F *h1_erel_neuland = new TH1F("h1_erel_neuland", "h1_erel_neuland", 300, 0, nErelLim);
    TH1F *h1_erel_neuland_p = new TH1F("h1_erel_neuland_p", "h1_erel_neuland_p", 300, 0, nErelLim);
    TH1F *h1_erel_neuland_plane1 = new TH1F("h1_erel_neuland_plane1", "h1_erel_neuland_plane1", 300, 0, nErelLim);
    TH2F *h2_erel_theta = new TH2F("h2_erel_theta", "h2_erel_theta", 300, 0, nErelLim, 300, 0, 9);
    ...
    TH1F *h1_eff = new TH1F("h1_eff", "h1_eff", 300, 0, nErelLim);

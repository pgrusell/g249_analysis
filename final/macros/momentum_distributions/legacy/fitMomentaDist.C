...
void fitMomentaDist()
{
    ...
    std::vector<std::string> inFilesTheo = {
        "/nucl_lustre/pablogrusell/g249/g249_analysis/theory/25F(p,2p)-1d32-Sp-18.469.txt",
        "/nucl_lustre/pablogrusell/g249/g249_analysis/theory/25F(p,2p)-2s12-Sp-12.403.txt",
        "/nucl_lustre/pablogrusell/g249/g249_analysis/theory/25F(p,2p)-1d52-Sp-15.969.txt",
    };
    ...
    auto momdis_1d32_18 = getMomentaDistFromtxt(inFilesTheo[0], "1d32_18");
    auto momdis_2s12_12 = getMomentaDistFromtxt(inFilesTheo[1], "2s12_12");
    auto momdis_1d52_15 = getMomentaDistFromtxt(inFilesTheo[2], "1d52_15");
    ...
    auto momdis_1d32_18_resampled = reampleMomDis(momdis_1d32_18, momdis_exp, "1d32_18");
    auto momdis_2s12_12_resampled = reampleMomDis(momdis_2s12_12, momdis_exp, "2s12_12");
    auto momdis_1d52_15_resampled = reampleMomDis(momdis_1d52_15, momdis_exp, "1d52_15");

    // Fit
    TObjArray *mc = new TObjArray(3);
    mc->Add(momdis_1d32_18_resampled.Qy);
    mc->Add(momdis_1d32_18_resampled.Qy);
    mc->Add(momdis_1d52_15_resampled.Qy);
